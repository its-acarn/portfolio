	...
	return (
		<>
			<div className="socials">
				<a href="https://www.linkedin.com/in/acarn/" rel="noreferrer">
					<svg
				...
				<a href="https://twitter.com/its_acarn" rel="noreferrer">
					<svg
						className="social-img"
						role="img"
						xmlns="http://www.w3.org/2000/svg"
				...
				<a href="https://github.com/its-acarn" rel="noreferrer">
					<svg
						className="social-img"
						role="img"
						viewBox="0 0 24 24"
				...
				<a href="https://codepen.io/acarn" rel="noreferrer">
					<svg
						className="social-img"
						role="img"
						xmlns="http://www.w3.org/2000/svg"
				...
				<a
					href="mailto:andrewpcar@gmail.com"
					rel="noreferrer"
				>
					<svg
						className="social-img"
			...
			<div className="name-wrapper">
				...
				>
					<p className="nameSub">
						I am a{' '}
						<span className="greenText">Software Developer</span>{' '}
						<br /> and{' '}
						<span className="greenText">Web Designer</span> <br />{' '}
						based in Edinburgh.
					</p>
				</div>
			</div>
